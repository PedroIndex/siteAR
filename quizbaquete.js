...
var perguntas = [
    {
        ...
        mensagemErro: 'Que pena, você errou. A resposta correta é: D) Kevin Durant.'
        //1
      },
      {
        ...
        imagem: '2.jfif',
        respostaCorreta: 'A',
        mensagemErro: 'Que pena, você errou. A resposta correta é: A) Allen Iverson.'
        //2
      },
      {
        ...
        imagem: 'shaq.jfif',
        respostaCorreta: 'C',
        mensagemErro: 'Que pena, você errou. A resposta correta é: C) 1.'
        //3
      },
      {
        ...
        respostaCorreta: 'D',
        mensagemErro: 'Que pena, você errou. A resposta correta é: D) Wilson.'
        //4
      },
      {
        ...
        respostaCorreta: 'C',
        mensagemErro: 'Que pena, você errou. A resposta correta é: C) 2019.'
        //5
      },
      {
        ...
        respostaCorreta: 'A',
        mensagemErro: 'Que pena, você errou. A resposta correta é: A) Maveric Dallas.'
        //6
      },
      {
        pergunta: 'Qual é o jogador acima?',
        ...
        mensagemErro: 'Que pena, você errou. A resposta correta é: B) Steve Adams.'
        //7
      },
      {
        ...
        imagem: 'kobe.jfif',
        respostaCorreta: 'D',
        mensagemErro: 'Que pena, você errou. A resposta correta é: D) 5.'
        //8
      },
      {
        ...
        imagem: 'kobemvp.jpg',
        respostaCorreta: 'B',
        mensagemErro: 'Que pena, você errou. A resposta correta é: B) 1.'
        //9
      },
      {
        pergunta: 'Quem é o maior cestinha da NBA?',
        opcoes: ['a) Stephen Curry', 'b) LeBron James', 'c) Kareem Abdul-Jabbar', 'd) Michael Jordan'],
        imagem: 'pontos.jpg',
        respostaCorreta: 'C',
        mensagemErro: 'Que pena, você errou. A resposta correta é: Kareem Abdul-Jabbar.'
        //10
      },
      {
        ...
        respostaCorreta: 'B',
        mensagemErro: 'Que pena, você errou. A resposta correta é: Wilt Chamberlain.'
        //11
      },
      {
        ...
        respostaCorreta: 'C',
        mensagemErro: 'Que pena, você errou. A resposta correta é: Golden State Warriors.'
        //12
      },
      {
        ...
        respostaCorreta: 'B',
        mensagemErro: 'Que pena, você errou. A resposta correta é: Allen Iverson.'
        //13
      },
      {
        ...
        respostaCorreta: 'D',
        mensagemErro: 'Que pena, você errou. A resposta correta é: 6.'
        //14
      },
      {
        ...
        respostaCorreta: 'C',
        mensagemErro: 'Que pena, você errou. A resposta correta é: John Stockton.'
        //15
      }
];
